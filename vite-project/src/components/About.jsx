    ...
    <div className="min-h-screen bg-gradient-to-br from-[#050b1d] via-[#07142f] to-[#020617] text-white">
      ...
      <section className="min-h-screen flex items-center justify-center px-6">
        <div className="text-center max-w-3xl">
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-6 rounded-full bg-white/5 border border-white/10 text-sm text-sky-400 backdrop-blur">
            <Lock size={16} />
          ...
          <p className="text-gray-400 text-base md:text-lg mb-10">
            Store and manage your website credentials securely. Keep everything organized in one safe place.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-8 py-3 rounded-full bg-sky-500 hover:bg-sky-600 transition font-semibold flex items-center gap-2 justify-center">
              Open Vault <ArrowRight size={18} />
            </button>
            <button className="px-8 py-3 rounded-full border border-green-400/40 text-green-400 hover:bg-green-400/10 transition font-semibold">
              Learn More
            </button>
          </div>
        </div>
      ...
      <section className="flex justify-center px-6 pb-24">
        <div className="w-full max-w-2xl p-6 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-6 rounded-2xl bg-white/5 border border-white/10">
                <div className="w-12 h-12 mb-6 rounded-xl bg-sky-500/20 flex items-center justify-center">{f[0]}</div>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 leading-tight">
              ...
              that respects <span className="text-sky-400">simplicity</span>
            </h2>
            <p className="text-gray-400 mb-6 leading-relaxed">
              In a world where we juggle dozens of online accounts, remembering every password is impossible. Password-Manager was created to solve this problem with a clean, intuitive interface.
            </p>
            <p className="text-gray-400 leading-relaxed">
              Whether it’s email, social media, developer tools, or banking portals — everything stays organized in one secure vault. No clutter. No complexity.
            </p>
          </div>
